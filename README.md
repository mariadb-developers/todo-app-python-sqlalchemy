...
This project uses the [MariaDB Python connector](https://github.com/mariadb-corporation/mariadb-connector-python) in combination with the [SQLAlchemy (SQL and object-relational mapping toolkit)](https://www.sqlalchemy.org/) to connect to and communicate to a MariaDB database instance.
